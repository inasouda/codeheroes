...
import { FaAward, FaHighlighter,FaUsers,FaAddressBook,FaEnvelope, FaPhone, FaRocket, FaLightbulb, FaBars, FaCode, FaSuperpowers, FaLaptopCode} from 'react-icons/fa';
